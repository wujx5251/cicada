...
<div class="col-xs-12">
    <div class="page-header" style="margin: 4px 0px">
        <h1>
            <i class="menu-icon fa fa-reply"></i> 退款记录列表
        </h1>
    </div>
    ...
    <div id="toolbar">
        <form class="form-inline">
            ...
            <div class="form-group">
                <label class="sr-only" for="recordNo">付款流水号</label>

                <div class="input-group">
                    <div class="input-group-addon">付款流水号</div>
                    <input type="text" class="form-control" name="recordNo" id="recordNo" placeholder="请输入平台付款流水号...">
                </div>
            </div>
            <div class="form-group">
...
<script src="js/refundrecord.js?_<%=Math.random()%>"></script>
</html>
