...
var changeFrameHeight = function (that) {
    ...
    $(that).parent(".tab-pane").height(document.documentElement.clientHeight - 160);
}
...
function bind(delegate, id) {
    $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
        if (delegate && $(e.target).attr('aria-controls') == id)
            delegate(e);
    });
}
$(function () {
