 ...
 * @version: 1.0
 **/
@Component(value = ComponetType.REFUND_QUERY, channel = Channel.WXPAY)
public class WxpayRefundQuery extends WxpayQuery {

    @Override
    protected String getAction() {
        return WxpayAction.REFUND_QUERY.value();
    }

    @Override
    protected Map<String, Object> getParams(TradingContext context) {
        Map<String, Object> params = new HashMap<String, Object>(1);
        params.put(WxpayParam.REFUND_NO.value(), context.getTarget().getRecordId());//退款单号
        return params;
    }
