 ...
 * @version: 1.0
 **/
public enum QqpayStatus implements Valuable {
    WAIT("NOTPAY", "未支付"),
    CLOSED("CLOSED", "已关闭"),
    ...
    QqpayStatus(String value, String desc) {
        this.value = value;
        this.desc = desc;
    }
    ...
    public static QqpayStatus from(String value) {
        if (StringUtils.isEmpty(value)) {
            return null;
        }

        for (QqpayStatus type : QqpayStatus.values()) {
